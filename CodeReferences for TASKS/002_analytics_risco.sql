...
ALTER TABLE analytics.metricas_obra
    ...
    ADD COLUMN IF NOT EXISTS risco_sobrecusto              NUMERIC(5, 4),   -- 0..1
    ADD COLUMN IF NOT EXISTS probabilidade_atraso          NUMERIC(5, 4),   -- 0..1 (Task 06)
...
-- Índice para o frontend filtrar por alerta sem full-scan
